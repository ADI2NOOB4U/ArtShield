		...
		<section id="cta" className="relative overflow-hidden py-32 sm:py-40 lg:py-48">
			...
			<div className="site-container relative z-10 text-center">
				<Reveal>
					...
					<div className="inline-flex items-center gap-2 rounded-full border border-ice-400/20 bg-ice-400/10 px-4 py-1.5 backdrop-blur-md">
						<span className="h-1.5 w-1.5 rounded-full bg-ice-400 shadow-[0_0_8px_#38bdf8]" />
						<span className="font-mono text-[11px] font-semibold uppercase tracking-[0.2em] text-ice-300">
							DEPLOY ART PROTECTION
						</span>
					</div>
				</Reveal>
				<Reveal delay={100}>
				...
				<Reveal delay={120}>
					<h2 className="mt-8 font-display text-[clamp(2.4rem,7vw,5.5rem)] font-bold leading-[0.95] tracking-tightest text-white">
						Protect the art.
						<br />
				...
				<Reveal delay={240}>
					<p className="mx-auto mt-8 max-w-xl text-sm leading-relaxed text-silver-300 sm:text-base lg:text-lg">
						Generate cryptographic certificates, latent watermarks, and verification proofs for your digital masterworks.
					</p>
				</Reveal>
				<Reveal delay={300}>
				...
				<Reveal delay={360}>
					<div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
						...
						<Link
							to={ROUTES.pricing}
							className="group inline-flex items-center justify-center gap-2.5 rounded-full border border-white/20 bg-white/[0.04] px-7 py-4 font-mono text-[12px] uppercase tracking-techno text-silver-100 backdrop-blur-md transition-all duration-300 hover:border-white/40 hover:bg-white/[0.08]"
						>
